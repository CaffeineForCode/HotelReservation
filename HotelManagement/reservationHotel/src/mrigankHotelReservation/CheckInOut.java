    ...
    public void createCheckedIn(String[][] checkInData, Hotels hot){
        ...
        for(int i = 1; i< checkInData.length; i++){
            ...
            if(count == 0){
                ...
                String dateFrom = checkInData[i][2];
                int nights = Integer.parseInt(checkInData[i][4]);
                int rooms = Integer.parseInt(checkInData[i][5]);
                String roomType = checkInData[i][6];
                int adults = Integer.parseInt(checkInData[i][7]);
                int children = Integer.parseInt(checkInData[i][8]);
                boolean breakfast = Boolean.parseBoolean(checkInData[i][9]);
                double deposit = Double.parseDouble(checkInData[i][10]);

                Reservation res = new Reservation(number, name, dateFrom, nights, rooms, roomType, adults, children, breakfast, deposit);
                int loop = 1;
    ...
    public void createCheckedOut(String[][] checkOutData, Hotels hot){
        ...
        for(int i = 1; i< checkOutData.length; i++){
            ...
            if(count == 0){
                ...
                String dateFrom = checkOutData[i][2];
                int nights = Integer.parseInt(checkOutData[i][4]);
                int rooms = Integer.parseInt(checkOutData[i][5]);
                String roomType = checkOutData[i][6];
                int adults = Integer.parseInt(checkOutData[i][7]);
                int children = Integer.parseInt(checkOutData[i][8]);
                boolean breakfast = Boolean.parseBoolean(checkOutData[i][9]);
                double deposit = Double.parseDouble(checkOutData[i][10]);
    ...
    public void createCancellations(String[][] cancellationsData, Hotels hot){
        ...
        for(int i = 1; i< cancellationsData.length; i++){
            ...
            if(count == 0){
                ...
                String dateFrom = cancellationsData[i][2];
                int nights = Integer.parseInt(cancellationsData[i][4]);
                int rooms = Integer.parseInt(cancellationsData[i][5]);
                String roomType = cancellationsData[i][6];
                int adults = Integer.parseInt(cancellationsData[i][7]);
                int children = Integer.parseInt(cancellationsData[i][8]);
                boolean breakfast = Boolean.parseBoolean(cancellationsData[i][9]);
                double deposit = Double.parseDouble(cancellationsData[i][10]);
